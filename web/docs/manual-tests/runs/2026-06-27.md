...
> ⏭️ **Skipped this run** — no iOS device available. Android (Run B) covers the
> two release-critical fixes (rotate crash, system back). iOS Safari to be run
> next cycle.
